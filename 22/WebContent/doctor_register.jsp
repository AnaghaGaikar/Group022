...
<h3 class="tittle">Doctor Registration</h3>
	<form class="form-horizontal" action="RegisterDoctor" method="post">
<div class="form-group">
    <label for="inputName3" class="col-sm-2 control-label hor-form">Doctor First Name:*</label>
    <div class="col-sm-6">
      <input type="text" class="form-control" required="required" name="firstName" pattern="[A-Za-z]{}" title="Name is always in letters" maxlength="30">
    </div>
  </div>
  <div class="form-group">
    <label for="inputName3" class="col-sm-2 control-label hor-form">Doctor Last Name:*</label>
    <div class="col-sm-6">
      <input type="text" class="form-control" required="required" name="lastName" pattern="[A-Za-z]{}" title="Name is always in letters" maxlength="30">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-6">
      <input type="text" class="form-control" id="contact" placeholder="Contact" width="100" required="required" name="contactNo" maxlength="15"pattern="[0-9]{}"title="contact_no is in number" maxlength="10">
    </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-sm-6">
      ...
      <input type="text" class="form-control" id="address" placeholder="Address" width="100" name="address" maxlength="500"pattern="[A-Za-z0-9]{}" title="address is always in letters" maxlength="30">
    </div>
  </div>
  <div class="form-group">
...
<!-- <select class="form-control input-md" placeholder="City" required="required" name="city"> 
  ...
  <div class="form-group">
    ...
    <div class="col-sm-6">
      <input type="text" class="form-control" id="pincode" placeholder="Pincode" width="100" name="pinCode" maxlength="6"title="pincode is always in letters">
    </div>
  </div>
  <div class="form-group">
    <label class="col-sm-2 control-label hor-form">Degree:</label>
    <div class="col-sm-6">
      <input type="text" class="form-control" id="degree" placeholder="Degree" width="100" name="degree" maxlength="50" pattern="[A-Za-z]{}" title="Name is always in letters" maxlength="30">
    </div>
  </div>
  <div class="form-group">
