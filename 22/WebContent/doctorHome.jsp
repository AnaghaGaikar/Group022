...
<link rel="shortcut icon" href="img/shortlogo.png"/>
...
<div class="left-content">
	   <div class="mother-grid-inner">
            <%@ include file="includes/doctorheader.jsp" %>
		<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="doctor.jsp">Home</a> <i class="fa fa-angle-right"></i></li>
            </ol>
...
<%@ include file="includes/doctorfooter.jsp" %>
</div>
</div>
  <!--//content-inner-->
			<%@ include file="includes/doctorsidebar.jsp" %>
