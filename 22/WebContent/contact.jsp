	...
	<div class="container">
		...
		<div class="container marginbot-50">
			<div class="row">
              ...
              <h3 class="t-button" style="margin-left: 300px;">
              <span class="label label-success" style="text-align: justify;">${resultMessage}</span>
              </h3>
              </div>
              <div class="form-group">
              <h3 class="t-button">
              <span class="label label-danger" style="text-align: justify;">${errorMessage}</span>
              </h3>
              </div>
				...
				<form action="addfeedback" method="post">
					...
					<textarea name="message" name="message"  required="required">Message...</textarea>
